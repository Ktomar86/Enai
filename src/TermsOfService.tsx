...
These terms are governed by the laws of England (UK). Disputes will be resolved in English courts.`;
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="modal-overlay fixed inset-0 bg-black bg-opacity-75" onClick={onClose}></div>
      <div className="min-h-screen px-4 text-center">
        <span className="inline-block h-screen align-middle" aria-hidden="true">&#8203;</span>
        <div className="modal-content inline-block w-full max-w-4xl p-6 my-8 text-left align-middle bg-gray-900 rounded-2xl shadow-xl transform transition-all border border-gray-800">
          ...
          <div className="overflow-y-auto max-h-[70vh] pr-6">
